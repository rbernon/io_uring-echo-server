...
all_targets = io_uring_echo_server io_uring_echo_server_link epoll_echo_server
...
io_uring_echo_server_link: io_uring_echo_server_link.c init_server_socket.c global.h
	$(CC) io_uring_echo_server_link.c init_server_socket.c -o io_uring_echo_server_link $(CCFLAGS)
